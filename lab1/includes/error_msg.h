...
# define ZERO_DIVISION "You want to divide by zero. Don't do that."
# define INVALID_OPERAND "You submitted a non-number. You can use real numbers or integers as operands."
