...
class NPDA(pda.PDA):
    ...
    def _get_transitions(self, state, input_symbol, stack_symbol):
        ...
        if (state in self.transitions and
            ...
            # print(f"state[{state}][input_symbol[{input_symbol}][stack_symbol[{stack_symbol}]")
            # print("value: ", self.transitions[state][input_symbol][stack_symbol])
            for (
                dest_state,
                new_stack_top
    ...
    def read_input_stepwise(self, input_str):
        ...
        current_configurations.add(PDAConfiguration(
            self.initial_state,
            input_str,
            PDAStack(list(self.initial_stack_symbol))
        ))
